...
const Contact = () => {
  ...
  const directionsUrl =
    'https://maps.app.goo.gl/hvc7AZuCZ3mFQxaW6';
      ...
      <div className="contact-container">
        ...
        <div className="contact-header">
          ...
          <h2 className="contact-title">
            Let's Begin a Happy Learning Journey
          </h2>

          <p className="contact-subtitle">
            Have a question about admissions, programs or day
            care? Reach out — we'd love to hear from you.
          </p>
        ...
        <div className="contact-cards-grid">
          ...
          <div className="contact-card">
            ...
            <a
              href="mailto:sunnybearspreschool@gmail.com"
          ...
          <div className="contact-card visit-card">
            ...
            <p className="contact-address">
              ...
              Raniammai 2nd Street, Sri Pachaiammai Nagar,
              Periyapancheri, Gerugambakkam, Chennai – 600128
            </p>
            ...
            <span className="landmark-tag">
              LANDMARK: OPP. KOCHAR ARJUN GARDEN
            </span>
